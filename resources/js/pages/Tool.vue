<template>
  <div>
    <Head title="Laravel Nova Meet The Team" />

    <Heading class="mb-6">Laravel Nova Meet The Team</Heading>
    ...
    >
      ...
      <p class="dark:text-white text-lg opacity-70">
        ...
        >
          /nova-components/LaravelNovaMeetTheTeam/resources/js/pages/Tool.vue
        </code>
      </p>
    </Card>
  </div>
